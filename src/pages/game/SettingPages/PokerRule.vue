  ...
  <van-overlay z-index="2000" :show="show" @click="emit('onClose')" class="bg-op-50!">
    <div class="wrapper-poker">
      <div
        ...
        <div v-if="selectIndex == 0" class="mt-2 overflow-y-scroll text-white w-full">
          <div>
            ...
            <div class=" pos-relative flex items-center justify-center mt-[-15px]">
              <img src="../../../assets/imgae/table/table1.png" class="w-[70%] h-[300px]" alt="" srcset="">
        ...
        <div v-if="selectIndex == 1" class="mt-2 overflow-y-scroll text-white w-full">
          <div class=" font-['Noto_Sans_SC']">
            <div v-for="(item, idx) in hands" :key="idx" class="flex items-center mb-2 last:mb-0">
              <div class="flex space-x-1 w-28">
                <Poker class="w-[40px]" v-for="(img, i) in item.cards" :key="i" :point="0" />
              </div>
              <div class="ml-2">
