  ...
  <van-overlay z-index="2000" :show="show" @click="emit('onClose')" class="bg-op-20!">
    <div class="wrapper-theme pos-relative ">
      <div
        ...
        <div v-ripple="{ class: `text-info` }" v-if="selectIndex == 0" class="flex flex-row flex-1  w-[96%] my-[10px] justify-evenly items-center">
        ...
        <div v-ripple="{ class: `text-info` }" v-if="selectIndex == 1" class="flex flex-row flex-1  w-[96%] my-[10px] justify-evenly  items-center">
        ...
        <div v-ripple="{ class: `text-info` }" v-if="selectIndex == 2" class="flex flex-row flex-1  w-[96%] my-[10px] justify-evenly  items-center">
        ...
        <van-button v-ripple="{ class: `text-info` }" @click="saveTheme" class="w-[90%]! mb-[15px]! "  block
